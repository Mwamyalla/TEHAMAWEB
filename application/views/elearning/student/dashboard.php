                                            ...
                                            <div class="card-body d-flex align-items-center">
                                                <a href="student-take-quiz.html"
                                                   class="avatar overlay overlay--primary avatar-4by3 mr-12pt">
                                                    <img src="<?=base_url().'assets/elearning'?>/images/paths/typescript_200x168.png"
                                    ...
                                    <div class="card-group-row__col col-md-6">
                                        ...
                                        <div class="card card-group-row__card card-sm">
                                            <div class="card-body d-flex align-items-center">
                                                <a href="student-take-quiz.html"
                                                   class="avatar overlay overlay--primary avatar-4by3 mr-12pt">
                                                    <img src="<?=base_url().'assets/elearning'?>/images/paths/angular_200x168.png"
                                    ...
                                    <div class="col-sm-6 col-xl-4 card-group-row__col">
                                        ...
                                        <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay card-group-row__card d-xl-none"
                                            ...
                                            <a href="student-take-course.html"
                                               ...
                                               data-position="left"
                                               data-height="140">
                                                <img src="<?=base_url().'assets/elearning'?>/images/paths/react_430x168.png"
                                                     alt="course">
                                                <span class="overlay__content">
                                                    <span class="overlay__action d-flex flex-column text-center">
                                                        <i class="material-icons icon-32pt">play_circle_outline</i>
                                        ...
                                        <div class="popoverContainer d-none">
                                            <div class="media">
                                                <div class="media-left mr-12pt">
                                                    <img src="<?=base_url().'assets/elearning'?>/images/paths/react_40x40@2x.png"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="carousel-item active">
                                            ...
                                            <a class="card border-0 mb-0"
                                               href="">
                                                <img src="<?=base_url().'assets/elearning'?>/images/achievements/flinto.png"
                                                     alt="Flinto"
                                                     class="card-img"
                                                ...
                                                <span class="card-body d-flex flex-column align-items-center justify-content-center fullbleed">
                                                    ...
                                                    <span class="row flex-nowrap">
                                                        <span class="col-auto text-center d-flex flex-column justify-content-center align-items-center">
                                                            <img src="<?=base_url().'assets/elearning'?>/images/illustration/achievement/128/white.png"
                                                                 width="64"
                                                                 alt="achievement">
                                                        </span>
                                                        <span class="col d-flex flex-column">
                                        ...
                                        <div class="carousel-item">
                                            ...
                                            <a class="card border-0 mb-0"
                                               href="">
                                                <img src="<?=base_url().'assets/elearning'?>/images/achievements/angular.png"
                                                     alt="Angular fundamentals"
                                                     class="card-img"
                                                     style="max-height: 100%; width: initial;">
                                                <div class="fullbleed bg-primary"
                                                ...
                                                <span class="card-body d-flex flex-column align-items-center justify-content-center fullbleed">
                                                    <span class="row flex-nowrap">
                                                        ...
                                                        <span class="col d-flex flex-column">
                                                            <span class="text-right flex mb-16pt">
                                                                <img src="<?=base_url().'assets/elearning'?>/images/paths/angular_64x64.png"
                                                                     width="64"
                                                                     alt="Angular fundamentals"
                                                                     class="rounded">
                                                            </span>
