                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <div class="js-player card bg-primary text-center embed-responsive embed-responsive-16by9 mb-24pt">
                                    <div class="player embed-responsive-item bg-white" >
                                        <div class="player__content align-items-center justify-content-center ">
											      <img src="<?=base_url().'assets/front/'?>images/course/python.jpg"
													class="avatar-img rounded" style="width:100%;"
													alt="preview">
                                ...
                                <div class="row mb-24pt">
                                    <div class="col-md-7">
                                        ...
                                        <p class="text-70">This course will teach you the fundamentals o*f working with Python 2. You *will learn everything you need to know to create complete applications including: components, services, directives, pipes, routing, HTTP, and even testing.</p>
                                        <p class="text-70 mb-0">This course will teach you the fundamentals o*f working with Python 2. You *will learn everything you need to know to create complete applications including: components, services, directives, pipes, routing, HTTP, and even testing.</p>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="page-separator">
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="d-flex align-items-center">
                                                ...
                                                <span class="text-70">Fundamentals of working with Python</span>
                                            </li>
                                            <li class="d-flex align-items-center">
                                                <span class="material-icons text-50 mr-8pt">check</span>
                                                <span class="text-70">Create complete Python applications</span>
                                            </li>
                                            <li class="d-flex align-items-center">
                                                <span class="material-icons text-50 mr-8pt">check</span>
                                                <span class="text-70">Working with the Python CLI</span>
                                            </li>
                                            <li class="d-flex align-items-center">
                                                <span class="material-icons text-50 mr-8pt">check</span>
                                            ...
                                            <li class="d-flex align-items-center">
                                                <span class="material-icons text-50 mr-8pt">check</span>
                                                <span class="text-70">Testing with Python</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="pb-16pt mb-16pt border-bottom row">
                                    <div class="col-md-3 mb-16pt mb-md-0">
                                        <div class="d-flex">
                                            <a href="student-profile.html"
                                               class="avatar avatar-sm mr-12pt">
                                                <!-- <img src="U" alt="avatar" class="avatar-img rounded-circle"> -->
                                                <span class="avatar-title rounded-circle">U</span>
                                            </a>
                                            <div class="flex">
                                                <p class="small text-muted m-0">2 days ago</p>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="card">
                                    <div class="card-body py-16pt text-center">
										...
										<a href="<?=base_url().'elearning/take_course'?>"
